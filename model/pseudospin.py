...
# plot pseudospin textures for all the CDIs
...
dz1 = np.cos(Y1)
dx1 = np.sin(Y1)*np.cos(X1)
dy1 = np.sin(Y1)*np.sin(X1)
...
dz1_2 = 0.5*(1+np.cos(X1_2))*(np.cos(2*Y1_2)-1)+1
dx1_2 = 0.5*(1+np.cos(X1_2))*np.sin(2*Y1_2)
dy1_2 = np.sin(X1_2)*np.sin(Y1_2)
...
dz2 = 1.0+np.cos(2*X2)+np.cos(2*Y2)
dx2 = -np.sin(X2)*np.sin(2*Y2)
dy2 = np.sin(2*X2)*np.sin(Y2)
...
dz3 = 2.0*(np.cos(1.5*X3+0.5*(3**0.5)*Y3)+np.cos(-1.5*X3+0.5*(3**0.5)*Y3)+np.cos((3**0.5)*Y3))\
    +np.cos(3.0*X3+(3**0.5)*Y3)+np.cos(-3.0*X3+(3**0.5)*Y3)+np.cos(2.0*(3**0.5)*Y3)+2.0
dx3 = np.sin(2.5*X3)*np.sin(0.5*(3**0.5)*Y3)-np.sin(2.0*X3)*np.sin((3**0.5)*Y3)+np.sin(0.5*X3)*np.sin(1.5*(3**0.5)*Y3)
dy3 = -np.cos(2.5*X3)*np.sin(0.5*(3**0.5)*Y3)-np.cos(2.0*X3)*np.sin((3**0.5)*Y3)+np.cos(0.5*X3)*np.sin(1.5*(3**0.5)*Y3)
...
x1 = np.linspace(-pi, pi, 31) 
y1 = np.linspace(-pi, pi, 31)
X4, Y4 = np.meshgrid(x1, y1)
dz4 = 3.0+np.cos(2*X4)+np.cos(2*Y4)+np.cos(4*X4)+np.cos(4*Y4)+4.0*np.cos(X4)*np.cos(Y4)
dx4 = -np.sin(X4)*np.sin(4*Y4)+np.sin(4*X4)*np.sin(Y4)
dy4 = np.sin(2*X4)*np.sin(4*Y4)-np.sin(4*X4)*np.sin(2*Y4)
...
X42, Y42 = np.meshgrid(x1, y1)
dz42 = 3.0+np.cos(2*X42)+np.cos(2*Y42)+np.cos(4*X42)+np.cos(4*Y42)+4.0*np.cos(X42)*np.cos(Y42)
dx42 = -np.sin(X42)*np.sin(4*Y42)+np.sin(4*X42)*np.sin(Y42)
dy42 = np.sin(2*X42)*np.sin(4*Y42)-np.sin(4*X42)*np.sin(2*Y42)
