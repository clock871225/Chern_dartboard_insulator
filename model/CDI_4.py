...
my_model.set_hop(t2, 0, 0, [ 4, 0])
my_model.set_hop(-t2, 1, 1, [ 4, 0])
my_model.set_hop(t2, 0, 0, [ 0, 4])
my_model.set_hop(-t2, 1, 1, [ 0, 4])
my_model.set_hop(t3, 0, 0, [ 1, 1])
my_model.set_hop(-t3, 1, 1, [ 1, 1])
my_model.set_hop(t3, 0, 0, [ 1, -1])
my_model.set_hop(-t3, 1, 1, [ 1, -1])
my_model.set_hop(t6, 0, 1, [ 1, 4])
my_model.set_hop(-t6, 0, 1, [ 1, -4])
my_model.set_hop(-t6, 0, 1, [ -1, 4])
my_model.set_hop(t6, 0, 1, [ -1, -4])
my_model.set_hop(-t6, 0, 1, [ 4, 1])
my_model.set_hop(t6, 0, 1, [ 4, -1])
my_model.set_hop(t6, 0, 1, [ -4, 1])
my_model.set_hop(-t6, 0, 1, [ -4,-1])
my_model.set_hop(t7, 0, 1, [ 2, 4])
my_model.set_hop(-t7, 0, 1, [ 2, -4])
my_model.set_hop(-t7, 0, 1, [ -2, 4])
my_model.set_hop(t7, 0, 1, [ -2, -4])
my_model.set_hop(-t7, 0, 1, [ 4, 2])
my_model.set_hop(t7, 0, 1, [ 4, -2])
my_model.set_hop(t7, 0, 1, [ -4, 2])
my_model.set_hop(-t7, 0, 1, [ -4,-2])
...
ax.set_yticklabels((-10.0,-5.0,0.0,5.0,10.0),fontsize=18)
